...
class HistoryRetrieverSet:
        ...
        *,
        ...
        return cls(
            ...
            dataset_history_retriever=(
                GlobalDatasetHistoryRetriever(dataset_path) if dataset_path is not None else None
            ),
    ...
    def historical_context(self, issue: SonarIssue) -> CombinedHistoricalContext:
        ...
        return CombinedHistoricalContext(
            local_sonar=retrieved_case_context(self.local_history_retriever, issue),
...
def retrieved_case_context(
    ...
    return cast(CaseHistoryRetriever, retriever).find_context(issue)
