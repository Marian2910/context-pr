...
INPUT_GITHUB_APP_ID_VALUE="$(input_value INPUT_GITHUB_APP_ID INPUT_GITHUB-APP-ID "${CONTEXTPR_GITHUB_APP_ID:-}")"
INPUT_GITHUB_INSTALLATION_ID_VALUE="$(input_value INPUT_GITHUB_INSTALLATION_ID INPUT_GITHUB-INSTALLATION-ID "${CONTEXTPR_GITHUB_INSTALLATION_ID:-}")"
...
export CONTEXTPR_GITHUB_APP_ID="$INPUT_GITHUB_APP_ID_VALUE"
export CONTEXTPR_GITHUB_INSTALLATION_ID="$INPUT_GITHUB_INSTALLATION_ID_VALUE"
